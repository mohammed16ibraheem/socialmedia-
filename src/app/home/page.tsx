...
import { FiMoreHorizontal, FiHeart, FiMessageCircle, FiShare2, FiThumbsDown } from "react-icons/fi";
...
export default function HomeFeedPage() {
  return (
    <div className="relative min-h-screen bg-[radial-gradient(circle_at_top,#f6f7ff,60%,#ecefff)]">
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-2 pb-28 pt-10">
            ...
            >
              <CardContent className="flex flex-col gap-5 p-0">
                ...
                <footer className="flex flex-col gap-4 px-6 pb-5">
                  <div className="flex items-center justify-end gap-1.5 text-xs text-[#5f648c] sm:text-sm">
                    <button
                      type="button"
                    ...
                    >
                      <span className="text-xs leading-none text-[#6756ff] sm:text-sm">
                        <FiHeart />
                      </span>
